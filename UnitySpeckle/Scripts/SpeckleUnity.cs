...
[System.Serializable]
public class ReceiverEvent : UnityEvent<SpeckleUnityReceiver>
{
}

public class SpeckleUnity : MonoBehaviour
{
    ...
    private SpeckleUnityReceiver Receiver;
    ...
    void Start()
    {
        ...
        {
            Receiver = transform.gameObject.AddComponent<SpeckleUnityReceiver>();

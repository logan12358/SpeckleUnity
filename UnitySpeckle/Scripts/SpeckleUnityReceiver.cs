...
public class SpeckleUnityReceiver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (bUpdateDisplay)
        {
            ...
            transform.GetComponent<SpeckleUnity>().OnUpdateReceived.Invoke(this);
        }
        if (bRefreshDisplay)
        {
    ...
    IEnumerator InitAsync(string inStreamID, string URL)
    {
        ...
        transform.GetComponent<SpeckleUnity>().OnReceiverCreated.Invoke(this);
    ...
    public void CreateObjects()
    {
        ...
        foreach (var layer in Client.Stream.Layers)
        {
            ...
            for (int i = 0; i < layer.ObjectCount; i++)
            {
                ...
                go.GetComponent<SpeckleUnityObjectData>().LayerName = LayerName;
